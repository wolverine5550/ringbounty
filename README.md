...
| **Company Intelligence Agent** | **Planned** (not shipped). Checklist: [`docs/company_id_task_manager.md`](docs/company_id_task_manager.md) (**CI-P** → **CI-11**); product spec: [`docs/claude_chat_company_finder.md`](docs/claude_chat_company_finder.md). v1: async research during qualify, **suggest-only** for `company_name` until user confirms Q13. **CI-P.3:** provenance on `claim_events` (`company_identification_source=company_intelligence`); Lane A spam keeps `company_name_source=nomorobo` — audit: [`docs/spikes/20260519140000-company-identification-source-audit.md`](docs/spikes/20260519140000-company-identification-source-audit.md). |
