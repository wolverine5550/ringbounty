/**
 * Phase 6.4 — Company identification for TCPA letter path (PRD §7 Step 2, Q13 in Phase 7).
 *
...
/** Stable token for `claim_events` when letter path is blocked pending company ID. */
 ...
 * Full identification happens on qualify Q13 (Phase 7.5); letter purchase stays blocked until then (§6.6).
 */
export const COMPANY_UNIDENTIFIED_CHECK_MESSAGE =
  "We could not automatically identify the company behind this number. You will need to name the caller during qualification before a demand letter can be generated. If you know who called, continue — you can enter the company name on the next steps.";

/** Returns true when TCPA letter should stay blocked for missing company (§6.4.3). */
